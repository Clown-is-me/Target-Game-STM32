...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SHIFT_CLOCK_Pin|SEG_DATA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BUZZER_Pin|SHIFT_LATCH_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SHIFT_CLOCK_Pin SEG_DATA_Pin */
  GPIO_InitStruct.Pin = SHIFT_CLOCK_Pin|SEG_DATA_Pin;
